...
public class Ticket {
	...
	public String toString() {
		return "\""+ticketNum+"\",\""+this.getMovie().getShowingDate().toString()+"\",\""+this.cinemaNum+"\",\""+this.showingTime.toString()+"\",\""+this.reservedSeats+"\",\""+this.totalPrice+"\", \""+(this.isActive()==true?"active":"cancelled")+"\"";
	}
